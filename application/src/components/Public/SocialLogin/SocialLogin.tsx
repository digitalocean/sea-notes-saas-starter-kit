...
type SocialLoginProps = {
  ...
  /** Function to set navigating/loading state */
  setNavigating: (status: boolean) => void;
};

/**
 * SocialLogin component renders OAuth login buttons (Google, GitHub)
 * and handles authentication using the provided setError, setSuccess,
 * and setNavigating functions.
 *
 * @param {SocialLoginProps} props - Functions to handle state updates
 * @returns {JSX.Element} The social login button stack
 */

/**
 * SocialLogin component renders OAuth login buttons (Google, GitHub)
 * and handles authentication using the provided state functions.
 */
const SocialLogin: React.FC<SocialLoginProps> = ({ setError, setNavigating }) => {
  ...
  const handleOAuthSignIn = async (provider: string) => {
    ...
    try {
      ...
      setError('Unexpected error occurred during OAuth sign-in.');
    } finally {
      setNavigating(false);
    }
  };
