...
describe('EnvironmentsListView', () => {
  it('renders loading state correctly', () => {
    ...
    expect(screen.getByTestId('environments-list-loading')).toBeInTheDocument();
  });
  ...
  it('renders error message when there is an error', () => {
    ...
    expect(screen.getByTestId('environments-list-error')).toBeInTheDocument();
    expect(screen.getByTestId('environments-list-error-message')).toHaveTextContent(errorMessage);
  });
  ...
  it('renders empty state message when there are no environments', () => {
    ...
    expect(screen.getByTestId('environments-list-empty')).toBeInTheDocument();
  });

  it('renders environments in a table', () => {
    render(
      <EnvironmentsListView
    ...
    expect(screen.getByTestId('environments-list-container')).toBeInTheDocument();
